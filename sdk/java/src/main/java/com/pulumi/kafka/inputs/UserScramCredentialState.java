...
public final class UserScramCredentialState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="scramMechanism")
    private @Nullable Output<String> scramMechanism;

    /**
     * @return The SCRAM mechanism used to generate the credential (SCRAM-SHA-256, SCRAM-SHA-512)
     * 
     */
    public Optional<Output<String>> scramMechanism() {
        return Optional.ofNullable(this.scramMechanism);
    }
    ...
    private UserScramCredentialState() {}
    ...
    public static Builder builder(UserScramCredentialState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserScramCredentialState();
        }

        public Builder(UserScramCredentialState defaults) {
            $ = new UserScramCredentialState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder scramMechanism(@Nullable Output<String> scramMechanism) {
        ...
        public UserScramCredentialState build() {
            return $;
        }
    }
