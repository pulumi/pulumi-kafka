...
class AclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] acl_host: Host from which principal listed in `acl_principal`
               will have access.
        :param pulumi.Input[_builtins.str] acl_operation: Operation that is being allowed or denied. Valid
        ...
        :param pulumi.Input[_builtins.str] acl_permission_type: Type of permission. Valid values are `Unknown`,
               `Any`, `Allow`, `Deny`.
        :param pulumi.Input[_builtins.str] acl_principal: Principal that is being allowed or denied.
        :param pulumi.Input[_builtins.str] acl_resource_name: The name of the resource.
        :param pulumi.Input[_builtins.str] acl_resource_type: The type of resource. Valid values are `Unknown`,
               `Any`, `Topic`, `Group`, `Cluster`, `TransactionalID`.
        :param pulumi.Input[_builtins.str] resource_pattern_type_filter: The pattern filter. Valid values
