...
class QuotaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] entity_type: The type of entity. Valid values are `client-id`, `user`, `ip`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] config: A map of string k/v attributes.
        :param pulumi.Input[_builtins.str] entity_name: The name of the entity to target.
        """
