...
class TopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] partitions: The number of partitions the topic should have.
        :param pulumi.Input[_builtins.int] replication_factor: The number of replicas the topic should have.
